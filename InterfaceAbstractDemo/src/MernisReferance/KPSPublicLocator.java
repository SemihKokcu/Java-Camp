...
public class KPSPublicLocator extends org.apache.axis.client.Service implements MernisReferance.KPSPublic {
    ...
    public MernisReferance.KPSPublicSoap getKPSPublicSoap() throws javax.xml.rpc.ServiceException {
    ...
    public MernisReferance.KPSPublicSoap getKPSPublicSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            MernisReferance.KPSPublicSoapStub _stub = new MernisReferance.KPSPublicSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (MernisReferance.KPSPublicSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                MernisReferance.KPSPublicSoapStub _stub = new MernisReferance.KPSPublicSoapStub(new java.net.URL(KPSPublicSoap_address), this);
                _stub.setPortName(getKPSPublicSoapWSDDServiceName());
                return _stub;
            }
        }
