...
public class KPSPublicSoapProxy implements MernisReferance.KPSPublicSoap {
  private String _endpoint = null;
  private MernisReferance.KPSPublicSoap kPSPublicSoap = null;
  ...
  private void _initKPSPublicSoapProxy() {
    try {
      kPSPublicSoap = (new MernisReferance.KPSPublicLocator()).getKPSPublicSoap();
  ...
  public MernisReferance.KPSPublicSoap getKPSPublicSoap() {
    if (kPSPublicSoap == null)
      _initKPSPublicSoapProxy();
